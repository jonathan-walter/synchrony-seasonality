...
lm.samp.same<-lm(rhoN~r+Kw+Kb+rho.b+sd.b+sd.b*rho.b+Kw*Kb, data=sampres.main, na.action=na.exclude)
summary(lm.samp.same)

lm.samp.noow<-lm(rhoN~r+Kw+rho.b+rho.w+sd.b+sd.w+sd.b*rho.b+sd.w*rho.w+rho.b*rho.w, data=sampres.main, na.action=na.exclude)
